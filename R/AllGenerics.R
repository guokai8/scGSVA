...
#' Get column names of GSVA object
#' @param x A GSVA object
#' @rdname colnames-methods
#' @aliases colnames,GSVA-method
#' @export
setMethod(
    f = "colnames",
    signature = "GSVA",
...
#' Get row names of GSVA object
#' @param x A GSVA object
#' @rdname rownames-methods
#' @aliases rownames,GSVA-method
#' @export
setMethod(
    f = "rownames",
    signature = "GSVA",
...
#' Get column names of Annot object
#' @param x An Annot object
#' @rdname colnames-methods
